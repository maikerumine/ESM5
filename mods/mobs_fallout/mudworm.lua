...
mobs:register_spawn("mobs_fallout:mudworm", {"es:mud", "default:mud","default:mud_flowing", "es:toxic_water_source",  "default:toxic_water_source", "es:toxic_water_flowing", "default:toxic_water_flowing"}, 9, -1, 9000, 2, 31000)
