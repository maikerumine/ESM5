...
local COORD = true -- Print tower co-ordinates to terminal (cheat)

local XMIN = 2000 -- Area for random spawn
local XMAX = 2400
local ZMIN = 2000
local ZMAX = 2400

local BASRAD = 77 -- Average radius at y = -32
local HEIGHT = 3333 -- Approximate height measured from y = -32
local CONVEX = 2.7 -- Convexity. <1 = concave, 1 = conical, >1 = convex
local VOID = 0.8 -- Void threshold. Controls size of central void
local NOISYRAD = 0.1 -- Noisyness of structure at base radius.
						-- 0 = smooth geometric form, 0.3 = noisy.
local NOISYCEN = 0.4 -- Noisyness of structure at centre
