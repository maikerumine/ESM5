...
mobs:register_mob("scifi_mobs:metroid", {
   ...
   view_range = 20,
   	drops = {
		{name = "basic_machines:power_cell", chance = 1, min = 1, max = 3},
		{name = "basic_machines:power_block", chance = 4, min = 1, max = 1},
		{name = "scifi_nodes:lightbar", chance = 2, min = 1, max = 1},
		{name = "scifi_nodes:black", chance = 2, min = 1, max = 1},
		{name = "basic_machines:power_rod", chance = 30, min = 1, max = 1},
	},
   animation = {
      speed_normal = 5,
      speed_run = 6,
...
mobs:register_mob("scifi_mobs:facehugger", {
   ...
   view_range = 7,
    drops = {
		{name = "mobs_fallout:meat_raw", chance = 1, min = 1, max = 1},
	},
   animation = {
      speed_normal = 12,
      speed_run = 20,
...
mobs:register_mob("scifi_mobs:r2", {
   ...
   shoot_offset = 1,
	...
	drops = {
		{name = "basic_machines:power_cell", chance = 1, min = 1, max = 3},
		{name = "basic_machines:power_block", chance = 4, min = 1, max = 1},
		{name = "scifi_nodes:glass", chance = 2, min = 1, max = 1},
		{name = "scifi_nodes:white2", chance = 2, min = 1, max = 1},
		{name = "basic_machines:power_rod", chance = 30, min = 1, max = 1},
	},
	animation = {
		speed_normal = 2,
...
mobs:register_spawn("scifi_mobs:r2", {"default:steel_block","default:desert_sand"}, 20, 10, 85000, 1, 31000)
...
mobs:register_mob("scifi_mobs:dalec", {
   ...
   sounds = {
	...
	view_range = 14,
		...
		{name = "basic_machines:power_cell", chance = 1, min = 1, max = 3},
		{name = "basic_machines:power_block", chance = 4, min = 1, max = 1},
		{name = "scifi_nodes:black_mesh", chance = 2, min = 1, max = 1},
		{name = "scifi_nodes:doomwall3", chance = 2, min = 1, max = 1},
		{name = "basic_machines:power_rod", chance = 30, min = 1, max = 1},
	},
	animation = {
		speed_normal = 2,
...
mobs:register_spawn("scifi_mobs:dalec", {"default:steel_block","default:desert_sand"}, 20, 10, 85000, 1, 31000)
...
mobs:register_mob("scifi_mobs:spidermech", {
   ...
   shoot_offset = 1,
	...
	view_range = 14,
		...
		{name = "basic_machines:power_cell", chance = 1, min = 1, max = 3},
		{name = "basic_machines:power_block", chance = 4, min = 1, max = 1},
		{name = "scifi_nodes:greenmetal", chance = 2, min = 1, max = 1},
		{name = "scifi_nodes:grnpipe", chance = 2, min = 1, max = 1},
		{name = "basic_machines:power_rod", chance = 30, min = 1, max = 1},
	},
	animation = {
		speed_normal = 10,
...
mobs:register_spawn("scifi_mobs:spidermech", {"default:snow","default:dirt_with_grass"}, 20, 10, 45000, 1, 31000)
...
mobs:register_mob("scifi_mobs:xenomorph", {
   ...
   shoot_offset = 1,
	...
	view_range = 14,
	drops = {
		{name = "mobs_fallout:meat_raw", chance = 1, min = 3, max = 6},
		{name = "mobs_futuremobs:claw", chance = 4, min = 1, max = 1},
...
mobs:register_spawn("scifi_mobs:xenomorph", {"default:steelblock","default:stone"}, 20, 10, 35000, 1, 31000)
...
mobs:register_mob("scifi_mobs:jabba", {
   ...
   shoot_offset = 1,
	...
	view_range = 14,
	drops = {
		{name = "mobs_fallout:meat_raw", chance = 1, min = 7, max = 12},
		{name = "lavalamp:lavalamp", chance = 14, min = 1, max = 1},
...
mobs:register_spawn("scifi_mobs:jabba", {"default:desert_sand"}, 20, 10, 65000, 1, 31000)
...
mobs:register_mob("scifi_mobs:bb8", {
   ...
   shoot_offset = 1,
	...
	drops = {
		{name = "basic_machines:power_cell", chance = 1, min = 1, max = 3},
		{name = "basic_machines:power_block", chance = 4, min = 1, max = 1},
		{name = "technic:fine_copper_wire", chance = 2, min = 1, max = 1},
		{name = "technic:motor", chance = 2, min = 1, max = 1},
		{name = "basic_machines:power_rod", chance = 30, min = 1, max = 1},
	},
	animation = {
		speed_normal = 10,
...
mobs:register_spawn("scifi_mobs:bb8", {"default:desert_sand","default:ice"}, 20, 10, 45000, 1, 31000)
...
mobs:register_spawn("scifi_mobs:cyberman", {"default:cobblestone","default:sand"}, 20, 10, 35000, 1, 31000)
...
mobs:register_spawn("scifi_mobs:bipedm", {"default:stone","default:desert_sand"}, 20, 10, 45000, 1, 31000)
...
mobs:register_spawn("scifi_mobs:giant", {"default:stone","default:dirt_with_grass"}, 20, 10, 45000, 1, 31000)
...
mobs:register_spawn("scifi_mobs:metalg", {"default:stone","default:dirt_with_dry_grass"}, 20, 10, 45000, 1, 31000)
...
mobs:register_spawn("scifi_mobs:assaultsuit", {"default:stone","default:dirt_with_grass"}, 20, 10, 45000, 1, 31000)
...
mobs:register_mob("scifi_mobs:tank", {
   ...
   sounds = {
	...
	drops = {
		...
		{name = "basic_machines:power_block", chance = 4, min = 1, max = 1},
		{name = "technic:fine_copper_wire", chance = 2, min = 1, max = 1},
		{name = "technic:hv_transformer", chance = 2, min = 1, max = 1},
		{name = "basic_machines:power_rod", chance = 30, min = 1, max = 1},
	},
	animation = {
		speed_normal = 2,
...
mobs:register_spawn("scifi_mobs:tank", {"default:dirt_with_grass","default:snow"}, 20, 10, 45000, 1, 31000)
...
mobs:register_mob("scifi_mobs:xwing", {
   ...
   sounds = {
	...
	view_range = 14,
	drops = {
		{name = "technic:machine_casing", chance = 1, min = 1, max = 1},
		{name = "basic_machines:power_block", chance = 4, min = 1, max = 1},
		{name = "scifi_nodes:lightbar", chance = 2, min = 1, max = 1},
		{name = "technic:hv_transformer", chance = 2, min = 1, max = 1},
		{name = "basic_machines:power_rod", chance = 30, min = 1, max = 1},
...
mobs:register_spawn("scifi_mobs:xwing", {"default:leaves","default:pine_needles"}, 20, 10, 45000, 1, 31000)
...
mobs:register_spawn("scifi_mobs:core", {"default:dirt_with_grass","default:steelblock"}, 20, 10, 45000, 1, 31000)
